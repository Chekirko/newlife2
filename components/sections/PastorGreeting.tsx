...
// =========================================
// PASTOR GREETING - Welcome section with SVG decorations
// With SVG organic shape, gradient decorations, waves
// =========================================

export interface PastorGreetingProps {
  preTitle?: string
  title: string
  subtitle?: string
  description?: string
...
export const PastorGreeting = ({
  ...
  return (
    <section className={`relative bg-gray-100 py-16 lg:py-24 overflow-hidden ${className || ''}`}>
      ...
      <figure className="absolute bottom-0 left-0 w-full" style={{ marginBottom: '-1px' }}>
        <svg
